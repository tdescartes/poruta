...
export const metadata: Metadata = {
  title: "Careers | Poruta",
  description: "Join the Poruta team and help transform African procurement with AI-powered automation.",
};
      ...
      <section className="flex-1 flex items-center justify-center py-32 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-surface-600 max-w-2xl mx-auto mb-4">
            We&apos;re building the future of African trade infrastructure. Check back soon for open positions.
          </p>
